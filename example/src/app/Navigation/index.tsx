...
import SegmentedButtonPage from '../Pages/SegmentedButton';
//#endregion
...
const Router = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name={PAGES_NAMES.RadioButtonGroupPage} component={RadioButtonGroupPage} />
      <Stack.Screen name={PAGES_NAMES.CheckBoxPage} component={CheckBoxPage} />
      <Stack.Screen name={PAGES_NAMES.CheckBoxGroupPage} component={CheckBoxGroupPage} />
      <Stack.Screen name={PAGES_NAMES.ChipPage} component={ChipPage} />
      <Stack.Screen name={PAGES_NAMES.ChipGroupPage} component={ChipGroupPage} />
      ...
      <Stack.Screen name={PAGES_NAMES.SegmentedButtonPage} component={SegmentedButtonPage} />
    </Stack.Navigator>
  );
};
